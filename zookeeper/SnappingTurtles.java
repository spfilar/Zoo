...
public class SnappingTurtles extends ReptilesAndAmphibians {

	public SnappingTurtles(String name, int age, String gender, String color, boolean adult, boolean alive,
	...
	public String toString() {
		return "SnappingTurtles [isReptile=" + isReptile + ", name=" + name + ", age=" + age + ", gender=" + gender
